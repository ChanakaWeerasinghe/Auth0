...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MdesForMerchants.GetDigitalAssetsRequestSchema = factory(root.MdesForMerchants.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('encryptedPayload')) {
        obj['encryptedPayload'] = ApiClient.convertToType(data['encryptedPayload'], Object);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Object} encryptedPayload
   */
