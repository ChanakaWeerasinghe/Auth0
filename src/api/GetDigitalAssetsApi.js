...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/GetDigitalAssetsRequestSchema} opts.getDigitalAssetsRequestSchema Contains an encrypted CardAccountData object.
    ...
    this.getDigitalAssets = function(opts, callback) {
      opts = opts || {};
      var postBody = opts['getDigitalAssetsRequestSchema'];
